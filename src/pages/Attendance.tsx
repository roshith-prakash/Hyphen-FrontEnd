  ...
  const getSelectedDayClasses = (): TodayClass[] => {
    ...
    return dayData.slots
      .map((slot) => {
        ...
        if (!isForUser || !subjectName) return null;
          ...
          {dates.map((date) => {
            ...
            return (
              <button
                ...
                className={`flex flex-col items-center min-w-[3.5rem] py-2 rounded-lg transition-all ${
                  isSelected
                  ...
                  <div className="flex items-center justify-between mt-3">
                    <div className="flex items-center gap-4">
                      <div className="flex flex-col">
                        <span className="text-[10px] uppercase tracking-wider text-zinc-400 font-bold">Attended</span>
                        <span className="text-sm font-medium text-zinc-900 dark:text-zinc-100">{subject.attended}</span>
                      </div>
                      <div className="flex flex-col">
                        <span className="text-[10px] uppercase tracking-wider text-zinc-400 font-bold">Conducted</span>
                        <span className="text-sm font-medium text-zinc-900 dark:text-zinc-100">{subject.totalHeld}</span>
                      </div>
                    </div>
                  </div>
                </div>
